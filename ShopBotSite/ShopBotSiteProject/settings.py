"""
Django settings for ShopBotSiteProject project.
...
SECRET_KEY = 'yum7r!m8y@a!pf^^bc-)_(p1&ot$!%jhw(h!d=xscug)p%^^(='
...
ROOT_URLCONF = 'ShopBotSiteProject.urls'
...
WSGI_APPLICATION = 'ShopBotSiteProject.wsgi.application'
