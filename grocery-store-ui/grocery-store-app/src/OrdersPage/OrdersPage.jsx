...
class OrdersPage extends React.Component {
    ...
    componentDidMount(){
        ...
        .then((result) => {
            ...
            this.setState({
                numOfPendingOrders: result.pendingOrders.length,
                numberOfCompletedOrders: result.completedOrders.length,
                allPendingOrders : result.pendingOrders,
                allCompletedOrders: result.completedOrders
            });
        },
        (error) => { }
        );
